...
class AboutController extends Controller{
    ...
    public function bragas(){
        ...
        $a_meta_seo['canonical'] = env('APP_URL').'Venta de bragas usadas. Eres de esos hombres fetichistas que les gusta la ropa interior feminina usadas? Ahora es el momento, tienes gran variedad de ofertas por Internet, he creado este articulo porque una amiga está interesada en vender este tipo de ropa interior. Solo tienes con contactar con ella o con el admin de esta web. Un saludo :)';
